...
docker_images_name="rpi_bmc:latest"  # Name and tag for the Docker image (lowercase only)
docker_container_name="rpi4_bmc"    # Name for the Docker container (lowercase only)
docker_workspace_path="/home/$USER/RPI4_BMC"  # Workspace path inside the container
device_path="/dev/sda"
##########################################################
